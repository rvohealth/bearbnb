...
describe('V1/Host/PlacesController', () => {
  ...
  describe('GET show', () => {
    const subject = async (place: Place, expectedStatus: number = 200) => {
  ...
  describe('POST create', () => {
    const subject = async (data: UpdateableProperties<Place>, expectedStatus: number = 201) => {
  ...
  describe('PATCH update', () => {
    const subject = async (place: Place, data: UpdateableProperties<Place>, expectedStatus: number = 204) => {
  ...
  describe('DELETE destroy', () => {
    const subject = async (place: Place, expectedStatus: number = 204) => {
